...
local translationService = require("util/TranslationService")
isTestMode = false
...
local addons = {{
  include = true,
  title = "Нічний Морок",
  summary = "• 2 нові сценарії\n\n• 4 нові дослідники\n\n• 238 нових карт",
  description = "У доповненні «Нічний морок» гравці досліджують ті закутки Аркгема, куди страшно сунутися навіть удень. У місті процвітає організована злочинність, потаємні культи намагаються догодити своїм темним володарям, химерний місяць висить у небі, а десь у нічному мороці чаяться незбагненні жахіття. Це доповнення містить два нові сценарії, нові зустрічі для кожної зони Аркгема, нових монстрів і нові аномалії, а також чотирьох нових дослідників, готових протистояти жахам з новими предметами, заклинаннями та союзниками.\n\n• 2 сценарії\n• 4 дослідники\n• 7 карт заголовків\n• 20 карт архіву\n• 12 карт аномалій\n• 48 карт подій\n• 72 карти зустрічей\n• 4 карти союзників\n• 4 карти предметів\n• 4 карти заклинань\n• 28 спеціальних карт\n• 12 початкових карт\n• 6 карт стану розшукуваний\n• 15 монстрів"
}, {
  include = false,
  title = "Під Темними Хвилями",
  summary = "2• 2 нові сценарії\n\n• 4 нові дослідники\n\n• 238 нових карт",
  description = "2У доповненні «Нічний морок» гравці досліджують ті закутки Аркгема, куди страшно сунутися навіть удень. У місті процвітає організована злочинність, потаємні культи намагаються догодити своїм темним володарям, химерний місяць висить у небі, а десь у нічному мороці чаяться незбагненні жахіття. Це доповнення містить два нові сценарії, нові зустрічі для кожної зони Аркгема, нових монстрів і нові аномалії, а також чотирьох нових дослідників, готових протистояти жахам з новими предметами, заклинаннями та союзниками.\n\n• 2 сценарії\n• 4 дослідники\n• 7 карт заголовків\n• 20 карт архіву\n• 12 карт аномалій\n• 48 карт подій\n• 72 карти зустрічей\n• 4 карти союзників\n• 4 карти предметів\n• 4 карти заклинань\n• 28 спеціальних карт\n• 12 початкових карт\n• 6 карт стану розшукуваний\n• 15 монстрів"
}, {
  include = false,
  title = "Таємниці Ордену",
  summary = "3• 2 нові сценарії\n\n• 4 нові дослідники\n\n• 238 нових карт",
  description = "3У доповненні «Нічний морок» гравці досліджують ті закутки Аркгема, куди страшно сунутися навіть удень. У місті процвітає організована злочинність, потаємні культи намагаються догодити своїм темним володарям, химерний місяць висить у небі, а десь у нічному мороці чаяться незбагненні жахіття. Це доповнення містить два нові сценарії, нові зустрічі для кожної зони Аркгема, нових монстрів і нові аномалії, а також чотирьох нових дослідників, готових протистояти жахам з новими предметами, заклинаннями та союзниками.\n\n• 2 сценарії\n• 4 дослідники\n• 7 карт заголовків\n• 20 карт архіву\n• 12 карт аномалій\n• 48 карт подій\n• 72 карти зустрічей\n• 4 карти союзників\n• 4 карти предметів\n• 4 карти заклинань\n• 28 спеціальних карт\n• 12 початкових карт\n• 6 карт стану розшукуваний\n• 15 монстрів"
}, {
  include = false,
  title = "Відлуння Минулого",
  summary = "4• 2 нові сценарії\n\n• 4 нові дослідники\n\n• 238 нових карт",
  description = "4У доповненні «Нічний морок» гравці досліджують ті закутки Аркгема, куди страшно сунутися навіть удень. У місті процвітає організована злочинність, потаємні культи намагаються догодити своїм темним володарям, химерний місяць висить у небі, а десь у нічному мороці чаяться незбагненні жахіття. Це доповнення містить два нові сценарії, нові зустрічі для кожної зони Аркгема, нових монстрів і нові аномалії, а також чотирьох нових дослідників, готових протистояти жахам з новими предметами, заклинаннями та союзниками.\n\n• 2 сценарії\n• 4 дослідники\n• 7 карт заголовків\n• 20 карт архіву\n• 12 карт аномалій\n• 48 карт подій\n• 72 карти зустрічей\n• 4 карти союзників\n• 4 карти предметів\n• 4 карти заклинань\n• 28 спеціальних карт\n• 12 початкових карт\n• 6 карт стану розшукуваний\n• 15 монстрів"
}}
...
local blueTokenBagId = "40bae0"
local redTokenBagId = "fe6c51"
local greenTokenBagId = "18c8c9"
...
function discardToShop(obj, objData)
  ...
  local shopObj = getShopObj(objData.type)
...
function submitScenario()
  ...
  self.UI.setAttribute('body', 'text', i18n.getStrById("MM_scenario" .. currentSetup.scenario .. "_desc"))
...
function chooseAddon(player, alt, id)
  local id = number(id:match("%d+"))
  currentAddon = id
  self.UI.setAttribute('addonTitle', 'text', addons[id].title)
  self.UI.setAttribute('addonImage', 'image', id)
  self.UI.setAttribute('addonSummary', 'text', addons[id].summary)
  self.UI.setAttribute('addonDescription', 'text', addons[id].description)
end
function inProgress(player, alt, id)
  broadcastToColor("Робота над цим доповненням ще триває.", player.color, {
    r = 1,
    g = 1,
    b = 1
  })
...
function toggleAddon()
  ...
  if addons[currentAddon].include then
    if currentAddon == 1 then
      self.UI.setAttribute('scenarioImage5', 'color', 'white')
      self.UI.setAttribute('scenarioTitle5', 'color', 'white')
      self.UI.setAttribute('scenario5', 'onClick', 'chooseScenario')
      self.UI.setAttribute('scenarioImage6', 'color', 'white')
      self.UI.setAttribute('scenarioTitle6', 'color', 'white')
      self.UI.setAttribute('scenario6', 'onClick', 'chooseScenario')
    end
    self.UI.setAttribute('addon_panel' .. currentAddon, 'color', '#ffffff22')
  else
    if currentAddon == 1 then
      if currentSetup.scenario == 5 or currentSetup.scenario == 6 then
        broadcastToAll(
          "Неможливо вимкнути доповнення, сценарій з якого обрано!", {
            r = 1,
            g = 0.5,
            b = 0.5
          })
      ...
      self.UI.setAttribute('scenarioImage5', 'color', 'gray')
      self.UI.setAttribute('scenarioTitle5', 'color', 'gray')
      self.UI.setAttribute('scenario5', 'onClick', '')
      self.UI.setAttribute('scenarioImage6', 'color', 'gray')
      self.UI.setAttribute('scenarioTitle6', 'color', 'gray')
      self.UI.setAttribute('scenario6', 'onClick', '')
    end
...
function onPlayerClickDeath(d)
  d.player.showConfirmDialog("Підтвердіть смерть дослідника", function()
    local box = getObjectFromGUID(boxId)
    if not box then
      return
    end
...
function updateGlobalXml(newXml)
  ...
  self.UI.setAttribute('body', 'text', i18n.getStrById("MM_scenario1_desc"))
...
function addConditionMat2()
  if gameData.addons[1] == true then
    ...
    conditionMatData.Memo = JSON.encode({name = "ConditionMat2", snps = snps})
...
function prepareLanguageBag(bag)
  ...
  for i = #bag.getObjects(), 1, -1 do
    ...
    if memoTable and memoTable.startPosition then
      ...
      runAfterRest(o, function(o)
        if o.type == "Generic" or o.type == "Tile" or o.type == "Card" or
          (memoTable.type and
            (memoTable.type == "dark pact" or memoTable.type == "blessed cursed" or memoTable.type == "archive")) then
          o.setRotation({0, 180, 0})
        end
      end)
    end
  ...
  for _, deckData in ipairs(shopMatData.decks) do
    for _, o in ipairs(getObjects()) do
      ...
      if o.type == "Deck" and oData and oData.type then
        ...
        elseif string.lower(oData.type) == "wanted" and not isFoundWanted then
          if oData.set and gameData.addons[oData.set] == true then
            local conditionMat2 = getObjectFromGUID(conditionMat2Id)
            if not conditionMat2 then
              return
            end

            local conditionMat2Data = parseJson(conditionMat2.memo)
            if not conditionMat2Data then
              return
            end

            if conditionMat2Data and conditionMat2Data.snps and conditionMat2Data.snps[oData.set] then
              local p = conditionMat2Data.snps[oData.set].Position
              o.setPosition(conditionMat2.positionToWorld(p):setAt("y", 3))
              isFoundWanted = true
            end
          else
            local box = getObjectFromGUID(boxId)
...
function prepareScenarioMonsterDeck()
  ...
  for _, obj in ipairs(getObjects()) do
    if obj.type == "Deck" then
      local objData = parseJson(obj.memo)
      local isSet = objData and (not objData.set or (objData.set and gameData.addons[objData.set] == true))
      if objData and objData.type and string.lower(objData.type) == "monster" and isSet then
        if monsterDeck then
          monsterDeck.putObject(obj)
          monsterDeck.memo = obj.memo
        else
          monsterDeck = obj
        end
      end
      ...
      elseif obj.type == "Deck" then
        ...
        if memo.type then
                    ...
                    spawnClue(function()
                      spawnClue(function()
                        spawnClue(function()
                          ...
                          broadcastToAll(i18n.getStrById("PB_next_phase") .. " " ..
                                           i18n.getStrById("PB_phase" .. gameData.phase) .. "!",
          ...
          elseif string.lower(memo.type) == "encounter" or string.lower(memo.type) == "anomaly" then
            ...
            local function containsDeck(tbl, memo)

              for _, v in pairs(tbl) do
                local isName = v.name and memo.name and string.lower(v.name) == string.lower(memo.name)
                local isType = v.type and memo.type and string.lower(v.type) == string.lower(memo.type)
                local isSet = not memo.set or (memo.set and gameData.addons[memo.set] == true)
                if isName and isType and isSet then
                  return v
                end
              end
              return false
            ...
            local deckData = containsDeck(scenarioInstruction.decks, memo)
            if deckData then
              if memo.name and not usedDecks[string.lower(memo.name)] and deckData.pos and scenarioMatData.positions[deckData.pos] then
...
function lockSetupScenarioComponents(obj, scenarioTiles)
  ...
  function processSetupTile(o, name, setupTileInfo)
    ...
    for _, tokenInfo in ipairs(setupTileInfo.tokens) do
      ...
      elseif tokenInfo.type == "Blue Marker" then
        blueTokenBag.takeObject({
          index = 0,
          position = o.positionToWorld(tokenInfo.position):setAt("y", 3)
        }).highlightOn("Blue", 5)
      elseif tokenInfo.type == "Red Marker" then
        redTokenBag.takeObject({
          index = 0,
          position = o.positionToWorld(tokenInfo.position):setAt("y", 3)
        }).highlightOn("Red", 5)
      elseif tokenInfo.type == "Green Marker" then
